...
function (_React$Component) {
  ...
  function ProgressBar() {
    ...
    _defineProperty(_assertThisInitialized(_this), "getColor", function (percent) {
      if (_this.props.percent === 100) return 'green';
      return _this.props.percent > 50 ? 'lightgreen' : 'red';
    });

    _defineProperty(_assertThisInitialized(_this), "getWidthAsPercentOfTotalWidth", function () {
  ...
  _createClass(ProgressBar, [{
    ...
    value: function render() {
      ...
      }, "\xA0\xA0\xA0\xA0\xA0\xA0\xA0\xA0", _react2["default"].createElement("div", {
        style: {
