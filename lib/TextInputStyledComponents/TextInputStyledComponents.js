...
function TextInput(_ref) {
  ...
  return _react2["default"].createElement(Fieldset, null, _react2["default"].createElement(_Label2["default"], {
    htmlFor: htmlId,
    label: label,
    required: required
    ...
    value: value,
    onChange: onChange
  }, props)), children, error && _react2["default"].createElement(Error, null, error));
}
